...
1. https://actionanand.github.io/glyph-forge/
...
```bash
git clone https://github.com/actionanand/glyph-forge.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/glyph-forge#1-skeleton angular-proj-name
```
